...
const Player = () => {
  ...
  const getCourseData = () => {
    ...
    if (findCourse) {
      ...
      // REMOVED: The auto-play logic was here. 
      // Now playerData stays null until user clicks a lecture.
    }
  }
    ...
    <>
      <div className='p-4 sm:p-10 flex flex-col-reverse md:grid md:grid-cols-2 gap-10 md:px-36'>
        ...
        <div className='md:mt-10'>
            ...
            <img src={courseData ? courseData.courseThumbnail : ''} alt="" className='w-full rounded' />
            }
        </div>
